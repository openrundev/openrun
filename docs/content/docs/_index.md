...
OpenRun is an open-source Apache-2.0 licensed project for easy declarative deployment of self-hosted web apps. OpenRun can deploy apps on a single machine using Docker/Podman or onto a Kubernetes cluster.
...
{{< card link="app" title="Hypermedia apps" subtitle="Developing hypermedia based apps" icon="html5_plain" >}}
