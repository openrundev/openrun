...
#    openrun apply --approve github.com/openrundev/openrun/examples/todo_derived.star
...
app("/todo/admin", "github.com/openrundev/openrun/examples/todo", auth="system", 
...
app("/todo/app", "github.com/openrundev/openrun/examples/todo", auth="system",
...
app("/todo/view", "github.com/openrundev/openrun/examples/todo", spec="python-fasthtml",
