...
app("/todo1", "github.com/openrundev/openrun/examples/todo", spec="python-fasthtml",
    params={"APP_MODULE":"admin:app"}, bindings=[default_database])

app("/todo2", "github.com/openrundev/openrun/examples/todo", spec="python-fasthtml",
    params={"APP_MODULE":"admin:app"}, bindings=[default_database])